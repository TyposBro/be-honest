...
import {SearchContainer, Search, SearchRow, SearchRowButtonH, SearchRowButtonF, NameField, Row, NameField} from "./index.styled";
...
export const Hr = () => {
  ...
  return (
    <Container>
      <InfoBlock>
      <Main>
        <Avatar src="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="AI avatar" width="100" />
        <InfoContainer>
